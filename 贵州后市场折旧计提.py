...
import os
os.getcwd()
os.chdir("G:\\R\\OneDrive\\跌价")#设定工作目录
os.getcwd()
excel_path = 'G:\\R\\OneDrive\\跌价\\贵州.xlsx'#设定读取excel路径
...
restult= pd.DataFrame(SQL(sql,"use saledata020"))
...
result2 = pd.DataFrame(SQL(sql2,"use saledata020"))#读取现在的库存
c = result2.loc[(result2['入库时间']>'2016-1-1'),['件号','数量','关联标志','入库时间','单价','合计金额']]#筛选早于2016-1-1的库存
c = c.reset_index()
nf = ('2016-11-25','2015-11-25','2014-11-25','2013-11-25')
